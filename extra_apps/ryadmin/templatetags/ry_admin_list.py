...
from .ry_base import InclusionAdminNode
...
def items_for_result(cl, result, form):
    """
    Generate the actual list of data. 返回form表单及里面的标签，标签属性
    """
...
def result_list(cl):
    ...
    result = {
        ...
        'num_sorted_fields': num_sorted_fields,  # 指定排序字段
